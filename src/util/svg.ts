...
export function loadSponsorImages(tier1Dir: string, tier2Dir: string): { dataUri: string; name: string }[] {
  ...
  loadFromDir(tier1Dir);
  loadFromDir(tier2Dir);
